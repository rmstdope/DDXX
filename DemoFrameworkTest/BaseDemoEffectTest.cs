...
namespace Dope.DDXX.DemoFramework
{
        ...
        IDemoMixer, IEffect, IPostProcessor
    {
        ...
        public ITexture2D CreateTexture2D(int width, int height, int numLevels, Microsoft.Xna.Framework.Graphics.ResourceUsage usage, Microsoft.Xna.Framework.Graphics.SurfaceFormat format)
        {
            throw new Exception("The method or operation is not implemented.");
        }
        ...
        public IVertexBuffer CreateVertexBuffer(Type typeVertexType, int numVerts, Microsoft.Xna.Framework.Graphics.ResourceUsage usage)
        {
            throw new Exception("The method or operation is not implemented.");
        }
        ...
        ITexture2D ITextureFactory.CreateFromFile(string name)
        {
            throw new Exception("The method or operation is not implemented.");
        }
        ...
        public ITexture2D CreateFromFunction(int width, int height, int numLevels, ResourceUsage usage, SurfaceFormat format, Fill2DTextureCallback callbackFunction)
        {
            throw new Exception("The method or operation is not implemented.");
        }
