...
namespace Dope.DDXX.DemoFramework
{
    ...
    public class TrackTest : DemoMockTest
    {
        ...
        public void TestInitializeOneEffectAndPostEffect()
        {
            ...
            track.Initialize(graphicsFactory, mixer, postProcessor);
        }
        ...
        {
            Expect.Once.On(pe1).Method("Initialize").With(graphicsFactory, postProcessor);
        }

        private void ExpectInitialize(IDemoEffect e1)
        {
            Expect.Once.On(e1).Method("Initialize").With(graphicsFactory, mixer, postProcessor);
        }
