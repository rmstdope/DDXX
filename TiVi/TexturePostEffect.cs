...
{
    public class TextFadingPostEffect : BaseDemoPostEffect
    {
        ...
        public TextFadingPostEffect(string name, float startTime, float endTime)
        ...
        public override void Render()
        {
            ...
            {
                using (ISurface surface = PostProcessor.OutputTexture.GetSurfaceLevel(0))
