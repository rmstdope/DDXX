...
namespace GameFramework
{
    public class GameExecuter : IGameExecuter
    {
        ...
        public void Initialize(IGameCallback game, IGraphicsFactory graphicsFactory, IInputDriver inputDriver, ITextureFactory textureFactory, IEffectFactory effectFactory, IPostProcessor postProcessor)
        {
            this.game = game;
        ...
        public void Render()
        {
            ...
            postProcessor.SetValue("Exposure", 0.15f);
