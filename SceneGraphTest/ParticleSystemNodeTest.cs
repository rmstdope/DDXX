    ...
    public class ParticleSystemNodeTest : D3DMockTest
    {
        ...
        public void StepAndKillAllButFour()
        {
            ...
            Expect.Once.On(vertexBuffer).Method("SetData").
                With(new MatchListAndArray(vertexList), Is.EqualTo(0), Is.EqualTo(4));
            // Exercise SUT
            system.Step();
            // Verify SUT
        ...
        public void StepNoCreate()
        {
            ...
            Expect.Once.On(vertexBuffer).Method("SetData").
                With(new MatchListAndArray(vertexList), Is.EqualTo(0), Is.EqualTo(2));
            // Exercise SUT
            system.Step();
            // Verify SUT
            Assert.AreEqual(2, system.ActiveParticles);
        ...
        public void StepAllCreated()
        {
            ...
            Expect.Once.On(vertexBuffer).Method("SetData").
                With(new MatchListAndArray(vertexList), Is.EqualTo(0), Is.EqualTo(20));
            // Exercise SUT
            system.Step();
            // Verify
            Assert.AreEqual(20, system.ActiveParticles);
        ...
        public void StepCreateOne()
        {
            ...
            Expect.Once.On(vertexBuffer).Method("SetData").
                With(new MatchListAndArray(vertexList), Is.EqualTo(0), Is.EqualTo(3));
            // Exercise SUT
            system.Step();
            // Verify
        ...
        public void StepCreateThree()
        {
            ...
            Expect.Once.On(vertexBuffer).Method("SetData").
                With(new MatchListAndArray(vertexList), Is.EqualTo(0), Is.EqualTo(5));
            // Exercise SUT
            system.Step();
            // Verify
        ...
        public void Draw2Particles()
        {
            ...
            Expect.Once.On(materialHandler).Method("SetupRendering").
                With(Is.EqualTo(new Matrix[] { system.WorldMatrix }), Is.EqualTo(view), Is.EqualTo(proj), Is.EqualTo(color), Is.Anything);
        ...
        private void ExpectVertexBuffer(int num)
        {
            Expect.Once.On(graphicsFactory).Method("CreateVertexBuffer").
                With(typeof(float), num, BufferUsage.WriteOnly).
