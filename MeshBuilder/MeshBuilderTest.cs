...
namespace Dope.DDXX.MeshBuilder
{
    ...
    public class MeshBuilderTest : IGraphicsFactory, IModel, IPrimitive, IDevice, ITextureFactory
    {
        ...
        ///// </summary>
        //[Test]
        //public void TestBoxNumVerticesSingleSegment()
        //{
        //    builder.CreateBoxPrimitive("Box", 10.0f, 20.0f, 30.0f, 1, 1, 1);
        //    IPrimitive box = builder.GetPrimitive("Box");
        //    Assert.IsInstanceOfType(typeof(Primitive), box, "Box should be of type Primitive.");
