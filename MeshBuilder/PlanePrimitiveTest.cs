...
namespace Dope.DDXX.MeshBuilder
{
    ...
    public class PlanePrimitiveTest : PrimitiveTest
    {
        ...
        {
            Primitive plane = Primitive.PlanePrimitive(10, 30, 1, 1, false);
        ...
        {
            Primitive plane = Primitive.PlanePrimitive(20, 40, 1, 4, false);
        ...
        {
            primitive = Primitive.PlanePrimitive(10, 20, 1, 1, false);
            int startVertex = 0;
            int startIndex = 0;
            int numVertices = 4;
            int numTriangles = 2;
        ...
        {
            primitive = Primitive.PlanePrimitive(20, 40, 2, 4, false);
            int startVertex = 0;
            int startIndex = 0;
            int numVertices = 15;
            int numTriangles = 16;
        ...
        {
            primitive = Primitive.PlanePrimitive(20, 40, 2, 4, true);
            int startVertex = 0;
            int startIndex = 0;
            int numVertices = 15;
            int numTriangles = 16;
        ...
        private void CheckTexCoords(bool texCoords, int widthSegments, int heightSegments)
        {
            int v = 0;
            for (int y = 0; y < heightSegments + 1; y++)
            {
