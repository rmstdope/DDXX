...
namespace Dope.DDXX.Graphics
{
    ...
    public class LightStateTest
    {
        ...
        public void TestBuildup()
        {
            ...
            lightState.NewState(position1, direction1, diffuse1);
            Assert.AreEqual(1, lightState.NumLights);

            lightState.NewState(position2, direction2, diffuse2);
            ...
            Assert.AreEqual(lightState.Color, new Vector3[] { diffuse1.ToVector3(), diffuse2.ToVector3() });
        }
