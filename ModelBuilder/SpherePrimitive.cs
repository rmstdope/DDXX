...
{
    public class SpherePrimitive : ModifierBase
    {
        protected class DummyPrimitive : ModifierBase
        {
        ...
        public override IPrimitive Generate()
        {
            ...
            welder.ConnectToInput(0, new DummyPrimitive(vertexList.ToArray(), indexList.ToArray()));
